    ...
    def Betting(self):
        try:
            ...
            if self.bet == "exit":
                ...
                self.ab = True
                try:
                    porcentage = int(input("do you wish to always bet what porcentage?"))
                    if porcentage > 100 or porcentage < 1:
                        print("thats not alowed, because of your uncoperativness we will put the porcentage to 10 and take a fee")
                        error = "lol"
                        int(error)
                    else:
                        self.bet = self.wallet / (100 / porcentage)
                except:
    ...
    def RPS(self):
        ...
        while  self.playing == True:
            ...
            try:
                ...
                #re beting
                if self.ab == True:
                    self.bet = round(self.wallet / (100 / self.porcentage))
                    if self.bet < 10:
